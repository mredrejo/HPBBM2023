...
opts_p <- c("ggplot(genes2, aes(x=Tumor, y=Expression,fill=Gene)) +  scale_fill_manual(values=c(\"#999999\", \"#E69F00\")) + geom_boxplot()", answer =  "ggplot(genes2, aes(x=Gene, y=Expression,fill=Gene)) +
  scale_fill_manual(values=c(\"#999999\", \"#E69F00\")) +
  geom_boxplot() + facet_wrap(.~ Tumor)",
