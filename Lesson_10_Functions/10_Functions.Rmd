...
In this second example, we have used the function `stopifnot()` to check for the codons. This function is a shortcut for a standard `if{}` or `ifelse{}` to check the codons and a stop if they are not found.
