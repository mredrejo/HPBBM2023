...
How can we do it with any DNA sequence?

```{r}
#version 3

orf2aa <- function(orf) {
  orf <- toupper(orf) #just in case
  if (nchar(orf) %% 3 != 0) {
...
lacz <- readLines("data/lacz.fa")
str(lacz)  #readLines command will create a vector of two elements
orf2aa(lacz[2])
```
