...
As we can see in the plot, the marks seem overall similar. Moreover, the ANOVA p-value is clearly higher than the significance level, we can conclude that **there is no significant differences between the marks over the three years analyzed.**
