...
How would you change de *wd* to the folder `HPBBM2023/data`?
...
We are using the same directory tree. Your *wd* is `HPBBM2022/data` and you need to save a data.frame named `table1` as `table1.csv` in the folder `HPBBM2022/data` using `;` as separator. How would you do it *without changing* the working directory?
